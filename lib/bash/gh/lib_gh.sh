...
base_bash_libs_gh_require_cli() {
    if (($# > 1)); then
        base_bash_libs_std_log_error -l base_bash_libs.gh "Usage: base_bash_libs_gh_require_cli [install_hint]"
        return 1
    fi
    ...
    command -v gh >/dev/null 2>&1 || {
        base_bash_libs_std_log_error -l base_bash_libs.gh "Required command 'gh' was not found on PATH."
        [[ -z "$install_hint" ]] || base_bash_libs_std_log_error -l base_bash_libs.gh "$install_hint"
        return 1
    }
}
...
__base_bash_libs_gh_sensitive_controls_usage__() {
    ...
    case "$__base_bash_libs_gh_controls_helper_name" in
        base_bash_libs_gh_report_command_failure)
            base_bash_libs_std_log_error -l base_bash_libs.gh \
                "Usage: base_bash_libs_gh_report_command_failure <status> [gh args...] or base_bash_libs_gh_report_command_failure --sensitive [--safe-display <label>] -- <status> [gh args...]"
            ;;
        *)
            base_bash_libs_std_log_error -l base_bash_libs.gh \
...
__base_bash_libs_gh_auth_status_diagnostics__() {
    ...
    base_bash_libs_gh_require_cli || return 1
    ...
    if ((__base_bash_libs_gh_auth_sensitive)); then
        ...
        while IFS= read -r __base_bash_libs_gh_auth_line || [[ -n "$__base_bash_libs_gh_auth_line" ]]; do
            [[ -n "$__base_bash_libs_gh_auth_line" ]] &&
                base_bash_libs_std_log_error -l base_bash_libs.gh "gh auth status: $__base_bash_libs_gh_auth_line"
        done <<<"$__base_bash_libs_gh_auth_output"
    fi
    [[ -z "$__base_bash_libs_gh_auth_login_hint" ]] || base_bash_libs_std_log_error -l base_bash_libs.gh "$__base_bash_libs_gh_auth_login_hint"
    return 1
}
...
base_bash_libs_gh_auth_status_diagnostics() {
    if (($# > 1)); then
        base_bash_libs_std_log_error -l base_bash_libs.gh "Usage: base_bash_libs_gh_auth_status_diagnostics [login_hint]"
        return 1
    fi
...
base_bash_libs_gh_report_command_failure() {
    ...
    __base_bash_libs_gh_parse_sensitive_controls__ __base_bash_libs_gh_report_public_consumed \
        ...
        base_bash_libs_gh_report_command_failure "$@" || return 1
    ((__base_bash_libs_gh_report_public_consumed == 0)) || shift "$__base_bash_libs_gh_report_public_consumed"

    if (($# < 1)); then
        __base_bash_libs_gh_sensitive_controls_usage__ base_bash_libs_gh_report_command_failure
        return 1
    fi
...
base_bash_libs_gh_run() {
    ...
    __base_bash_libs_gh_parse_sensitive_controls__ __base_bash_libs_gh_run_consumed __base_bash_libs_gh_run_sensitive \
        __base_bash_libs_gh_run_safe_display base_bash_libs_gh_run "$@" || return 1
...
base_bash_libs_gh_repo_from_remote_url() {
    if (($# != 2)); then
        base_bash_libs_std_log_error -l base_bash_libs.gh "Usage: base_bash_libs_gh_repo_from_remote_url <remote_url> <result_variable_name>"
        return 1
    fi
    __base_bash_libs_std_assert_public_variable_names__ base_bash_libs_gh_repo_from_remote_url "${2-}" || return 1
    ...
    base_bash_libs_std_assert_variable_name "$__base_bash_libs_gh_result_name" || return 1
    __base_bash_libs_std_assert_writable_output__ base_bash_libs_gh_repo_from_remote_url "$__base_bash_libs_gh_result_name" || return 1
...
base_bash_libs_gh_infer_repo_from_origin() {
    if (($# < 2 || $# > 3)) || { (($# == 3)) && [[ "$3" != "--optional" ]]; }; then
        base_bash_libs_std_log_error -l base_bash_libs.gh "Usage: base_bash_libs_gh_infer_repo_from_origin <repo_dir> <result_variable_name> [--optional]"
        return 1
    fi
    __base_bash_libs_std_assert_public_variable_names__ base_bash_libs_gh_infer_repo_from_origin "${2-}" || return 1
    ...
    base_bash_libs_std_assert_variable_name "$__base_bash_libs_gh_infer_result_name" || return 1
    __base_bash_libs_std_assert_writable_output__ base_bash_libs_gh_infer_repo_from_origin "$__base_bash_libs_gh_infer_result_name" || return 1
    ...
    if [[ -z "$__base_bash_libs_gh_infer_remote_url" ]] ||
        ...
        base_bash_libs_std_log_error -l base_bash_libs.gh "Could not infer GitHub repository from '$__base_bash_libs_gh_infer_repo_dir' origin remote."
        return 1
    fi
...
base_bash_libs_gh_repo_default_branch() {
    if (($# != 2)); then
        base_bash_libs_std_log_error -l base_bash_libs.gh "Usage: base_bash_libs_gh_repo_default_branch <owner/repo> <result_variable_name>"
        return 1
    fi
    __base_bash_libs_std_assert_public_variable_names__ base_bash_libs_gh_repo_default_branch "${2-}" || return 1
    ...
    base_bash_libs_std_assert_variable_name "$__base_bash_libs_gh_repo_result_name" || return 1
    __base_bash_libs_std_assert_writable_output__ base_bash_libs_gh_repo_default_branch "$__base_bash_libs_gh_repo_result_name" || return 1
    ...
    if ((__base_bash_libs_gh_repo_status != 0)); then
        base_bash_libs_gh_report_command_failure "$__base_bash_libs_gh_repo_status" repo view "$__base_bash_libs_gh_repo" --json defaultBranchRef --jq .defaultBranchRef.name
        return $?
    fi
    if [[ -z "$__base_bash_libs_gh_repo_default_branch" ]]; then
        base_bash_libs_std_log_error -l base_bash_libs.gh "GitHub repository '$__base_bash_libs_gh_repo' does not report a default branch."
        return 1
    fi
...
__base_bash_libs_gh_api_controls_usage__() {
    base_bash_libs_std_log_error -l base_bash_libs.gh \
        "Usage: base_bash_libs_gh_api_with_retry [--sensitive] [--safe-display <label>] [--retry-policy read-only|never|replay-safe] [--max-attempts <1..10>] [--max-elapsed-seconds <1..3600>] [--attempt-timeout-seconds <1..600>] [--base-delay-seconds <0..60>] [--max-delay-seconds <1..300>] -- <endpoint> [gh api args...]"
}
...
__base_bash_libs_gh_parse_api_controls__() {
        ...
        case "${1-}" in
            ...
            --safe-display)
                if ((__base_bash_libs_gh_controls_display_seen)) || (($# < 2)) ||
                    ! __base_bash_libs_std_is_safe_display__ "${2-}"; then
                    base_bash_libs_std_log_error -l base_bash_libs.gh \
                        "base_bash_libs_gh_api_with_retry: --safe-display requires one non-empty printable ASCII label that does not begin with '-'."
                    return 1
                fi
            ...
            --retry-policy)
                ...
                case "$2" in
                    ...
                    *)
                        base_bash_libs_std_log_error -l base_bash_libs.gh \
                            "base_bash_libs_gh_api_with_retry: --retry-policy must be read-only, never, or replay-safe."
                        return 1
                        ;;
                esac
            ...
            *)
                base_bash_libs_std_log_error -l base_bash_libs.gh \
                    "base_bash_libs_gh_api_with_retry: framework controls must end with -- before GitHub arguments."
                return 1
                ;;
        esac
    done
    ...
    if ((!__base_bash_libs_gh_controls_separator)); then
        base_bash_libs_std_log_error -l base_bash_libs.gh \
            "base_bash_libs_gh_api_with_retry: framework controls require -- before GitHub arguments."
        return 1
    fi
    if ((__base_bash_libs_gh_controls_display_seen && !__base_bash_libs_gh_controls_sensitive_value)); then
        base_bash_libs_std_log_error -l base_bash_libs.gh \
            "base_bash_libs_gh_api_with_retry: --safe-display is valid only with --sensitive."
        return 1
    fi
    if ((__base_bash_libs_gh_controls_base_value > __base_bash_libs_gh_controls_cap_value)); then
        base_bash_libs_std_log_error -l base_bash_libs.gh \
            "base_bash_libs_gh_api_with_retry: --base-delay-seconds must not exceed --max-delay-seconds."
        return 1
    fi
...
# the authoritative retry state in base_bash_libs_gh_api_with_retry.
...
__base_bash_libs_gh_api_finish__() {
    ...
    if ((__base_bash_libs_gh_finish_status == 0)); then
        ...
        [[ -z "$__base_bash_libs_gh_finish_reason" ]] ||
            base_bash_libs_std_log_warn -l base_bash_libs.gh "$__base_bash_libs_gh_finish_reason"
    else
        [[ -z "$__base_bash_libs_gh_finish_reason" ]] ||
            base_bash_libs_std_log_warn -l base_bash_libs.gh "$__base_bash_libs_gh_finish_reason"
        base_bash_libs_std_log_error -l base_bash_libs.gh \
        ...
        if ((__base_bash_libs_gh_finish_suppress_stdout)); then
            base_bash_libs_std_log_warn -l base_bash_libs.gh \
...
__base_bash_libs_gh_api_with_retry_impl__() {
    ...
    if ! command chmod 700 "$__base_bash_libs_gh_api_owned_workspace" 2>/dev/null ||
        ...
        base_bash_libs_std_log_error -l base_bash_libs.gh \
            "base_bash_libs_gh_api_with_retry: could not secure the retry capture workspace."
        return 1
    fi
    if ! __base_bash_libs_gh_api_start_capture_guardian__ __base_bash_libs_gh_api_guardian_pid \
        ...
        __base_bash_libs_gh_api_cleanup_workspace__ "$__base_bash_libs_gh_api_owned_workspace"
        base_bash_libs_std_log_error -l base_bash_libs.gh \
            "base_bash_libs_gh_api_with_retry: could not start the retry capture guardian."
        return 1
    fi
    ...
    if ! : > "$__base_bash_libs_gh_api_stdout" 2>/dev/null ||
        ...
        __base_bash_libs_gh_api_cleanup_workspace__ "$__base_bash_libs_gh_api_owned_workspace"
        base_bash_libs_std_log_error -l base_bash_libs.gh \
            "base_bash_libs_gh_api_with_retry: could not secure retry capture files."
        return 1
    fi

    # base_bash_libs_std_run owns a single TERM-then-KILL supervisor. GNU timeout/gtimeout,
    ...
    if ! __base_bash_libs_gh_api_call_hook__ monotonic __base_bash_libs_gh_api_hook_result ||
        ...
        base_bash_libs_std_log_error -l base_bash_libs.gh \
            "base_bash_libs_gh_api_with_retry: could not initialize the elapsed-time budget."
        return 1
    fi
    ...
    while ((__base_bash_libs_gh_api_attempt <= __base_bash_libs_gh_api_max_attempts)); do
        ...
        if ! __base_bash_libs_gh_api_call_hook__ monotonic __base_bash_libs_gh_api_hook_result ||
            ...
            __base_bash_libs_gh_api_cleanup_capture__ "$__base_bash_libs_gh_api_stdout" "$__base_bash_libs_gh_api_stderr"
            base_bash_libs_std_log_error -l base_bash_libs.gh \
                "base_bash_libs_gh_api_with_retry: could not read the elapsed-time budget."
            return 1
        fi
        ...
        if ((__base_bash_libs_gh_api_now < __base_bash_libs_gh_api_start)); then
            ...
            __base_bash_libs_gh_api_cleanup_capture__ "$__base_bash_libs_gh_api_stdout" "$__base_bash_libs_gh_api_stderr"
            base_bash_libs_std_log_error -l base_bash_libs.gh \
                "base_bash_libs_gh_api_with_retry: elapsed-time clock moved backwards."
            return 1
        fi
