    ...
    for ((__base_bash_libs_arg_left_index = 0; __base_bash_libs_arg_left_index < ${#__base_bash_libs_arg_distinct_names[@]}; __base_bash_libs_arg_left_index++)); do
        for ((__base_bash_libs_arg_right_index = __base_bash_libs_arg_left_index + 1;
            ...
            if [[ "${__base_bash_libs_arg_distinct_names[__base_bash_libs_arg_left_index]}" == "${__base_bash_libs_arg_distinct_names[__base_bash_libs_arg_right_index]}" ]]; then
                base_bash_libs_std_log_error -l base_bash_libs.arg \
                    "base_bash_libs_arg_parse: caller-owned variables must be distinct; '${__base_bash_libs_arg_distinct_names[__base_bash_libs_arg_left_index]}' was provided more than once."
                return 1
            fi
        done
    done
...
__base_bash_libs_arg_preflight_repeatable_names__() {
    ...
    while (($#)); do
        if [[ "${1#*|}" == repeatable\|* ]]; then
            __base_bash_libs_std_assert_public_variable_names__ base_bash_libs_arg_parse "${1%%|*}" || return 1
        fi
        shift
    done
    return 0
...
__base_bash_libs_arg_parse_specs__() {
    ...
    for __base_bash_libs_arg_spec in "${__base_bash_libs_arg_specs[@]+"${__base_bash_libs_arg_specs[@]}"}"; do
        ...
        if [[ "$__base_bash_libs_arg_spec" == "$__base_bash_libs_arg_remainder" || "$__base_bash_libs_arg_remainder" == "$__base_bash_libs_arg_tokens_part" ||
            ...
            base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: malformed option spec '$__base_bash_libs_arg_spec'."
            return 2
        fi
        if ! [[ "$__base_bash_libs_arg_name" =~ $__base_bash_libs_arg_name_re ]]; then
            base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option spec '$__base_bash_libs_arg_spec' name must be a valid Bash identifier."
            return 2
        fi
        if [[ -n "${__base_bash_libs_arg_seen_names[$__base_bash_libs_arg_name]+set}" ]]; then
            base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option spec name '$__base_bash_libs_arg_name' is duplicated."
            return 2
        fi
        ...
        if [[ "$__base_bash_libs_arg_kind" != "flag" && "$__base_bash_libs_arg_kind" != "value" &&
            ...
            base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option spec '$__base_bash_libs_arg_name' must use kind 'flag', 'value', or 'repeatable'."
            return 2
        fi

        if [[ "$__base_bash_libs_arg_kind" == "repeatable" ]]; then
            if [[ -z "$__base_bash_libs_arg_repeatable_names_name" ]]; then
                base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: repeatable option spec '$__base_bash_libs_arg_name' requires an output array contract."
                return 2
            fi
            __base_bash_libs_std_assert_public_variable_names__ base_bash_libs_arg_parse "$__base_bash_libs_arg_name" || return 1
            __base_bash_libs_arg_assert_distinct_names__ \
            ...
            if ! __base_bash_libs_std_declares_array_kind__ "$__base_bash_libs_arg_name" "a"; then
                base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: repeatable option '$__base_bash_libs_arg_name' requires a caller-declared indexed array."
                return 2
            fi
            __base_bash_libs_std_assert_writable_output__ base_bash_libs_arg_parse "$__base_bash_libs_arg_name" || return 1
        ...
        if [[ "$__base_bash_libs_arg_tokens_part" == "|"* || "$__base_bash_libs_arg_tokens_part" == *"|" ||
            ...
            base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option spec '$__base_bash_libs_arg_spec' contains an empty option token."
            return 2
        fi
        ...
        for __base_bash_libs_arg_token in "${__base_bash_libs_arg_tokens[@]+"${__base_bash_libs_arg_tokens[@]}"}"; do
            if ! [[ "$__base_bash_libs_arg_token" =~ $__base_bash_libs_arg_token_re ]] || [[ "$__base_bash_libs_arg_token" == *"="* ]]; then
                base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option spec '$__base_bash_libs_arg_spec' has invalid option token '$__base_bash_libs_arg_token'."
                return 2
            fi
            if [[ -n "${__base_bash_libs_arg_seen_tokens[$__base_bash_libs_arg_token]+set}" ]]; then
                base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option token '$__base_bash_libs_arg_token' is duplicated."
                return 2
            fi
...
#
# base_bash_libs_arg_parse - Parses simple flags and value options into caller-owned variables.
#
...
base_bash_libs_arg_parse() {
    if (($# < 4)) || [[ "${4-}" != "--" ]]; then
        base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: usage: base_bash_libs_arg_parse <options_assoc> <positionals_array> <specs_array> -- [args...]"
        return 2
    fi
    __base_bash_libs_std_assert_public_variable_names__ base_bash_libs_arg_parse "${1-}" "${2-}" "${3-}" || return 1
    ...
    base_bash_libs_std_assert_variable_name "$__base_bash_libs_arg_options_name" "$__base_bash_libs_arg_positionals_name" "$__base_bash_libs_arg_specs_name"
    ...
    base_bash_libs_std_assert_associative_array "$__base_bash_libs_arg_options_name"
    base_bash_libs_std_assert_indexed_array "$__base_bash_libs_arg_positionals_name" "$__base_bash_libs_arg_specs_name"
    __base_bash_libs_std_assert_writable_output__ base_bash_libs_arg_parse "$__base_bash_libs_arg_options_name" || return 1
    __base_bash_libs_std_assert_writable_output__ base_bash_libs_arg_parse "$__base_bash_libs_arg_positionals_name" || return 1
    ...
    while (($# > 0)); do
        ...
        if ((__base_bash_libs_arg_parse_options)) && [[ "$__base_bash_libs_arg_current" == --*=* ]]; then
            ...
            if [[ -z "$__base_bash_libs_arg_option_kind" ]]; then
                base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: unknown option '$__base_bash_libs_arg_option_token'."
                return 2
            fi
            if [[ "$__base_bash_libs_arg_option_kind" != "value" && "$__base_bash_libs_arg_option_kind" != "repeatable" ]]; then
                base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option '$__base_bash_libs_arg_option_token' does not accept a value."
                return 2
            fi
        ...
        if ((__base_bash_libs_arg_parse_options)) && [[ "$__base_bash_libs_arg_current" == -* && "$__base_bash_libs_arg_current" != "-" ]]; then
            ...
            if (($# == 0)); then
                base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option '$__base_bash_libs_arg_option_token' requires a value."
                return 2
            fi
            if [[ -n "${1-}" ]]; then
                if [[ -n "${__base_bash_libs_arg_token_kind[$1]+set}" ]]; then
                    base_bash_libs_std_log_error -l base_bash_libs.arg "base_bash_libs_arg_parse: option '$__base_bash_libs_arg_option_token' requires a value before option '$1'."
                    return 2
                fi
            fi
